...
/*
 * legacy_sec_input_register_notify
...
EXPORT_SYMBOL(legacy_sec_input_register_notify);

/*
 * legacy_sec_input_unregister_notify
 * @nb: pointer of blocking notifier chain structure
 * 
 * unregister notifier
 */
...
EXPORT_SYMBOL(legacy_sec_input_unregister_notify);

/*
 * legacy_sec_input_notify
 * @nb: pointer of blocking notifier chain structure
...
EXPORT_SYMBOL(legacy_sec_input_notify);

/*
 * legacy_sec_input_self_request_notify
 * @nb: pointer of blocking notifier chain structure
 *
 * only test
 */
...
EXPORT_SYMBOL(legacy_sec_input_self_request_notify);
