...
EXPORT_SYMBOL(decon_is_tui_trans);
...
/**
 * decon_exynos_atomic_enter_tui - save the current state and disable lcd display
 *
...
EXPORT_SYMBOL(decon_exynos_atomic_enter_tui);
...
EXPORT_SYMBOL(decon_exynos_atomic_exit_tui);
...
EXPORT_SYMBOL(decon_exynos_tui_get_resolution);
...
EXPORT_SYMBOL(decon_exynos_tui_set_stui_funcs);
#endif
...
EXPORT_SYMBOL(decon_exynos_tui_get_panel_info);
