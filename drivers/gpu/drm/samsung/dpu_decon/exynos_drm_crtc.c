...
/**
 * decon_exynos_drm_crtc_add_crc_entry - Add entry with CRC information for a frame
 ...
 */
int decon_exynos_drm_crtc_add_crc_entry(struct drm_crtc *crtc, bool has_frame,
...
EXPORT_SYMBOL_GPL(decon_exynos_drm_crtc_add_crc_entry);
