...
struct panel_display_mode *decon_exynos_panel_find_panel_mode(
...
EXPORT_SYMBOL(decon_exynos_panel_find_panel_mode);

/**
 * decon_exynos_panel_mode_create - create a new exynos panel mode
 * @ctx: exynos_panel
 *
 ...
 */
struct exynos_panel_mode *decon_exynos_panel_mode_create(struct exynos_panel *ctx)
{
...
EXPORT_SYMBOL(decon_exynos_panel_mode_create);


/**
 * decon_exynos_panel_mode_destroy - remove a mode
 * @ctx: exynos_panel
 * @mode: mode to remove
 *
 * Release @mode's unique ID, then free it @mode structure itself using kfree.
 */
void decon_exynos_panel_mode_destroy(struct exynos_panel *ctx, struct exynos_panel_mode *mode)
{
	if (!mode)
		return;
...
EXPORT_SYMBOL(decon_exynos_panel_mode_destroy);


/**
 * decon_exynos_panel_desc_create - create a new exynos panel desc
 * @ctx: exynos_panel
 *
 ...
 */
struct exynos_panel_desc *decon_exynos_panel_desc_create(struct exynos_panel *ctx)
{
...
EXPORT_SYMBOL(decon_exynos_panel_desc_create);


/**
 * decon_exynos_panel_desc_destroy - remove a desc
 * @ctx: exynos_panel
 * @desc: desc to remove
 *
 * Release @desc's unique ID, then free it @desc structure itself using kfree.
 */
void decon_exynos_panel_desc_destroy(struct exynos_panel *ctx, struct exynos_panel_desc *desc)
{
	if (!desc)
		return;
...
EXPORT_SYMBOL(decon_exynos_panel_desc_destroy);
...
decon_exynos_panel_desc_create_from_panel_display_modes(struct exynos_panel *ctx,
		struct panel_display_modes *pdms)
{
	...
	desc = decon_exynos_panel_desc_create(ctx);
	if (!desc) {
...
modefail:
	...
	kfree(lp_modes);
	kfree(unique_modes);
	decon_exynos_panel_desc_destroy(ctx, desc);
	return NULL;
}
EXPORT_SYMBOL(decon_exynos_panel_desc_create_from_panel_display_modes);
