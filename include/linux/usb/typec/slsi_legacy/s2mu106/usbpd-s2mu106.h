...
#define S2MU106_PD_GPADC_SHORT(x) ((x) >= S2MU106_WATER_GPADC_SHORT)

#define S2MU106_IS_CC_OR_UNDER_RA(cc1, cc2)\
	((cc1 <= S2MU106_WATER_THRESHOLD_RA_MV) || (cc2 <= S2MU106_WATER_THRESHOLD_RA_MV))
#define S2MU106_IS_CC_AND_UNDER_WATER(cc1, cc2)\
	((cc1 <= S2MU106_WATER_THRESHOLD_MV) && (cc2 <= S2MU106_WATER_THRESHOLD_MV))

#define S2MU106_IS_CC_WATER(cc1, cc2)\
	((cc1 <= S2MU106_WATER_THRESHOLD_MV) && (cc2 >= (cc1*S2MU106_WATER_POST/10)))
#define S2MU106_IS_CC_DRY(pd1, pd2)    \
	((pd1 > S2MU106_DRY_THRESHOLD_MV) && (pd2 > S2MU106_DRY_THRESHOLD_MV))
#define S2MU106_IS_CC_DRY_POST(pd1, pd2)    \
...
#define S2MU106_ENABLED_INT_0    (S2MU106_REG_INT_STATUS0_MSG_GOODCRC |\
						S2MU106_REG_INT_STATUS0_MSG_ACCEPT)
#define S2MU106_ENABLED_INT_1    (S2MU106_REG_INT_STATUS1_MSG_PING |\
...
#define S2MU106_ENABLED_INT_2    (S2MU106_REG_INT_STATUS2_MSG_VCONN_SWAP |\
						S2MU106_REG_INT_STATUS2_MSG_WAIT |\
						S2MU106_REG_INT_STATUS2_MSG_REQUEST)
#define S2MU106_ENABLED_INT_2_WAKEUP    (S2MU106_REG_INT_STATUS2_MSG_VCONN_SWAP |\
						S2MU106_REG_INT_STATUS2_MSG_WAIT |\
						S2MU106_REG_INT_STATUS2_MSG_SOFTRESET |\
						S2MU106_REG_INT_STATUS2_WAKEUP)
#define S2MU106_ENABLED_INT_3    S2MU106_REG_INT_STATUS3_UNS_CMD_DATA
#define S2MU106_ENABLED_INT_4    (S2MU106_REG_INT_STATUS4_USB_DETACH |\
				S2MU106_REG_INT_STATUS4_PLUG_IRQ |\
				S2MU106_REG_INT_STATUS4_MSG_PASS |\
				S2MU106_REG_INT_STATUS4_MSG_ERROR)
#define S2MU106_ENABLED_INT_4_WATER    (S2MU106_REG_INT_STATUS4_MSG_PASS |\
				S2MU106_REG_INT_STATUS4_MSG_ERROR)
#define S2MU106_ENABLED_INT_4_CCOPEN    (S2MU106_REG_INT_STATUS4_USB_DETACH |\
				S2MU106_REG_INT_STATUS4_MSG_PASS |\
				S2MU106_REG_INT_STATUS4_MSG_ERROR)
#define S2MU106_ENABLED_INT_5    (S2MU106_REG_INT_STATUS5_HARD_RESET)
